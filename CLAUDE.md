...
- Do NOT create documentation files (*.md, *.txt), plans, or new entry points unless the task requires it
- Do NOT refactor or add type annotations to code unrelated to the task
